...
class PrecisionTestSuite:
    ...
    async def setup_test_system(self, motor_ids: Optional[List[int]] = None):
    ...
    async def test_basic_precision(self, save_recording: Optional[str] = None) -> Dict[str, Any]:
        """
        ...
        print("="*70)
        print("This test records simple XY movements and measures playback precision.")
        print("Instructions:")
        print("  1. Move X and Y axes manually to create a simple path")
        print("  2. Suggested: Square pattern or simple back-and-forth")
        print("  3. Recording will run for 30 seconds")
        print("  4. System will then play back your movements")
        print("-"*70)
    ...
    async def test_complex_path(self, save_recording: Optional[str] = None) -> Dict[str, Any]:
        """
        Complex path test with curved movements and speed variations.
        """
        print("\n" + "="*70)
        print("🌀 COMPLEX PATH PRECISION TEST")
        print("="*70)
        print("This test records complex curved movements and measures precision.")
        print("Instructions:")
        print("  1. Create smooth, curved movements (circles, figure-8s, etc.)")
        print("  2. Vary your movement speed during recording")
        print("  3. Use both XY positioning and Z height changes")
        print("  4. Recording will run for 45 seconds")
        print("-"*70)
