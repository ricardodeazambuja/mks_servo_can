"""
Multi-Motor Digitizer Base Class

This module provides a general-purpose digitizer system for MKS servo motors that can:
1. Record motor positions during manual movement (motors disabled)
2. Play back recorded movements with high precision
3. Test system precision by comparing recorded vs. playback positions
4. Support any number of motors and axis configurations

The digitizer can be used for:
- Manual teaching of robot paths
- System calibration and precision testing
- Complex trajectory recording and reproduction
