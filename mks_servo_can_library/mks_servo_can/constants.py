...
CMD_SAVE_CLEAN_SPEED_MODE_PARAMS = (
    0xFF  # Note: Overlaps with 0xFF for error in read response [cite: 286]
)
...
CMD_RUN_POSITION_MODE_ABSOLUTE_AXIS = (
    0xF5  # V1.0.5 (Supports real-time update) [cite: 2]
)
...
DEFAULT_STEPS_PER_REVOLUTION = (
    200 * 16
)  # Assuming 200 base steps and default 16 microsteps [cite: 43]
